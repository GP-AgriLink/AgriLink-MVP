                ...
                <Form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Field
                      ...
                      className={`w-full rounded-[12px] border px-4 py-3 text-base outline-none transition-all focus:ring-2 ${errors.name && touched.name
                  ...
                  <div>
                    ...
                    <Field
                      ...
                      disabled={submitLoading}
                      className={`w-full rounded-[12px] border px-4 py-3 text-base outline-none transition-all focus:ring-2 ${errors.email && touched.email
                        ? 'border-red-300 bg-red-50/30 focus:border-red-400 focus:ring-red-200'
                        : 'border-emerald-200/60 bg-emerald-50/40 focus:border-emerald-500 focus:ring-emerald-500/20'
                        } ${submitLoading ? 'cursor-not-allowed opacity-60' : ''}`}
                    />
                  ...
                  <div>
                    ...
                    <Field
                      ...
                      disabled={submitLoading}
                      rows="5"
                      className={`w-full rounded-[12px] border px-4 py-3 text-base outline-none transition-all resize-none focus:ring-2 ${errors.message && touched.message
                        ? 'border-red-300 bg-red-50/30 focus:border-red-400 focus:ring-red-200'
                        : 'border-emerald-200/60 bg-emerald-50/40 focus:border-emerald-500 focus:ring-emerald-500/20'
                        } ${submitLoading ? 'cursor-not-allowed opacity-60' : ''}`}
                    />
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-[24px] border border-emerald-200/50 p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:agrilink.corp@gmail.com" className="inline-block text-emerald-600 font-semibold hover:text-emerald-700 transition-colors">
                    agrilink.corp@gmail.com
                  </a>
                </div>
              </div>
            </div>
