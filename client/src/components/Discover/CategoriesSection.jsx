  ...
  return (
    <div className="group relative h-80 w-full max-w-[20rem] overflow-hidden rounded-2xl shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
      ...
      <div className="relative flex h-full flex-col justify-end p-6">
        ...
        <p className="mt-1 text-base leading-relaxed text-gray-200">{description}</p>
      </div>
    </div>
  );
};
...
const categoryDetails = {
  ...
  Herbs: {
    description:
      "Aromatic, fresh-cut herbs like basil, mint, and rosemary to elevate your cooking.",
...
const CategoriesSection = () => {
  ...
  return (
    <section className="mb-10 py-16 sm:py-24">
