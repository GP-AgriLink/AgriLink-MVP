  ...
  return (
    <header className="font-['Inter'] bg-white/70 backdrop-blur-md sticky top-0 z-[100] border-b border-emerald-100/70 shadow-[0_-4px_16px_rgba(6,78,59,0.7)] rounded-b-2xl">
      <div className="w-full lg:w-5/6 mx-auto flex justify-between items-center px-4 md:px-6 py-4 md:py-5">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          {!user ? (
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={`transition-transform duration-300 stroke-white relative z-10 ${isDropdownOpen ? 'rotate-180' : ''
                      }`}>
            ...
            <>
              <button
                onClick={() =>
                  handleNavigateToDashboard('orders')
                }
                className="group relative w-11 h-11 rounded-xl bg-gradient-to-br from-slate-50 to-gray-50 backdrop-blur-sm border border-slate-200/70 flex items-center justify-center transition-all duration-300 hover:bg-gradient-to-br hover:from-emerald-500 hover:via-teal-500 hover:to-cyan-600 hover:border-emerald-400/80 hover:shadow-xl hover:shadow-emerald-500/40 hover:-translate-y-0.5 hover:scale-105"
              ...
              <div className="relative" ref={profileDropdownRef}>
                <button
                  ...
                  <div className="relative w-full h-full">
                    <div className="w-12 h-12 rounded-full overflow-hidden ring-2 ring-emerald-500/30 group-hover:ring-emerald-500/60 transition-all shadow-lg">
                      <img
                        src={
                          avatarUrl ||
                          avatarPlaceholder
                      ...
                      <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-gradient-to-br from-emerald-500 via-teal-500 to-emerald-600 rounded-full ring-2 ring-white shadow-sm"></div>
                  </div>
                </button>
        ...
        <button
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className={`stroke-white transition-transform duration-300 ${isMobileMenuOpen ? 'rotate-90' : ''
              }`}>
            {isMobileMenuOpen ? (
              <>
      ...
      {isMobileMenuOpen && (
        <div
          ref={mobileMenuRef}
          className="lg:hidden bg-white/98 backdrop-blur-md border-t border-emerald-100/50 shadow-lg overflow-y-auto max-h-[calc(100vh-60px)]">
          <div className="px-4 py-5 space-y-2.5">
            {!user ? (
              ...
              <>
                ...
                <button
                  onClick={() =>
                    handleNavigateToDashboard('products')
                  }
