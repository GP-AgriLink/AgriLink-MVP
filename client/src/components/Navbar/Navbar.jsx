...
function Navbar() {
  const { user, logout, incomingOrdersCount, avatarUrl } = useAuth();
        ...
        <div ref={mobileMenuRef} className="lg:hidden bg-white/98 backdrop-blur-xl border-t border-emerald-100/50 shadow-2xl">
          <div className="px-4 py-5 space-y-2.5">
            ...
            {!user ? (
              ...
              <>
                {/* (جزء الـ Profile في الموبايل زي ما هو) */}
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 flex items-center justify-center group-hover:from-indigo-500/20 group-hover:to-purple-500/20 transition-all shadow-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="stroke-indigo-600">
                      <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                      <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                    </svg>
                  </div>
