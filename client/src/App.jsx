...
import { CartProvider } from "./context/CartContext"; // Your change (Kept)
...
import Dashboard from "./pages/Dashboard";
import FarmStorePage from "./pages/FarmStorePage";
import CartPage from "./pages/CartPage"; // Your change (Kept)
...
function App() {
  return (
    <AuthProvider>
      {/* Your CartProvider is now wrapped around MainLayout */}
      <CartProvider>
        <MainLayout>
          <Routes>
            {/* --- PUBLIC ROUTES --- */}
            ...
            {/* Your Cart Route (Kept) */}
            <Route path="/cart" element={<CartPage />} />

            {/* --- PROTECTED ROUTES (from dev) --- */}
            <Route
              path="/dashboard"
              element={
                <ProtectedRoute>
